...
function PasswordStrength({ password }) {
  ...
  const bars = [
    { label: "Weak", color: "bg-destructive", active: strength >= 1 },
    { label: "Fair", color: "bg-orange-500", active: strength >= 2 },
    { label: "Good", color: "bg-yellow-500", active: strength >= 3 },
    { label: "Strong", color: "bg-emerald-500", active: strength >= 4 },
  ];
    ...
    <div className="mt-1 space-y-0.5">
      <div className="flex gap-0.5">
        {bars.map((bar, i) => (
          <div
            key={i}
            className={`h-0.5 flex-1 rounded-full transition-colors duration-300 ${bar.active ? bar.color : "bg-border"
              }`}
          />
        ))}
      </div>
              ...
              <FieldGroup>
                ...
                >
                  ...
                  <p className="text-balance text-xs text-muted-foreground">
                    Join thousands of teams streamlining their HR
                  </p>
                </motion.div>
